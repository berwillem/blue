      ...
      <form className={styles.form}>
        ...
        <section className={styles.gdprSection}>
          ...
          <div className={styles.gdprText}>
            ...
            <p><strong>Data Retention:</strong> Personal data will be retained only for the duration necessary to evaluate the application and, if applicable, to initiate further discussions. Data will not be shared with third parties.</p>
          </div>
          ...
          <div className={styles.consentBox}>
            ...
            <label className={styles.checkboxLabel}>
              <input type="checkbox" required /> I consent to the processing of my data for the purposes described above
            </label>
          </div>
        </section>
        ...
        <div className={styles.actions}>
          ...
          <p className={styles.finalNote}>
            Applications are reviewed individually. Selected applicants may be invited to a confidential, non-binding discussion.
          </p>
        </div>
      </form>
    </div>
