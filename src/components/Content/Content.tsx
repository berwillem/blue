  ...
  return (
    ...
    >
      ...
      <div className={`content-container ${isPC ? "sticky-active" : ""}`}>
        ...
        <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-300px" }} transition={{ duration: 0.8 }} className="mobile">
          ...
          <div className="button-container">
            <Link
              to={
                DATA[currentIndex]?.button === "Start a metabolic test" ||
                DATA[currentIndex]?.button === "Commencer un test métabolique"
                  ? "/tests/metabolic-health"
                  : DATA[currentIndex]?.button === "Personal Capacity test" ||
                      DATA[currentIndex]?.button ===
                        "Test de capacité personnelle"
                    ? "/tests/personal-capacity"
                    : "/contact"
              }
            >
              ...
              <motion.div layout className="button-container">
                <Link
                  to={
                    DATA[currentIndex]?.button === "Start a metabolic test" ||
                    DATA[currentIndex]?.button ===
                      "Commencer un test métabolique"
                      ? "/tests/metabolic-health"
                      : DATA[currentIndex]?.button ===
                            "Personal Capacity test" ||
                          DATA[currentIndex]?.button ===
                            "Test de capacité personnelle"
                        ? "/tests/personal-capacity"
                        : "/contact"
              ...
              <AnimatePresence mode="popLayout" initial={false}>
                ...
                >
                  <motion.div
                    ...
                    transition={{
                      duration: 3,
                      // times définit QUAND chaque valeur arrive (entre 0 et 1)
                      // Ici : reste à 100% jusqu'à 80% du temps (2.4s), puis tombe à 0%
                      times: [0.3, 1],
                      ease: "easeInOut",
                    }}
                  >
